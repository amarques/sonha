      ...
      <div class="twelve columns centered">
      	...
      	<div class="cadBox">
				...
				<form onSubmit="return valida(this);">
					...
					<div class="imgBtn">
						<input type="submit" class="button2 fade3" value="Carregar imagem" tabindex="1"/>
					</div>
                    <div class="clear">
						<input type="text" placeholder="e-mail" name="email" tabindex="9" />
						<span id="email" class="erro">Campo obrigat처rio. Preencha o e-mail corretamente</span>
					</div>
                    <div class="clear">
						<div>
							<input type="text" placeholder="nome" name="name" tabindex="7" />
							<span id="nome" class="erro">Campo obrigat처rio. Preencha o nome corretamente.</span>
						</div>
					</div>
					<div class="clear">
						<div>
							<input type="text" placeholder="sobrenome" name="lastname" tabindex="7" />
							<span id="nome" class="erro">Campo obrigat처rio. Preencha o nome corretamente.</span>
						</div>
					</div>
					<div class="clear">
						<div>
							...
							<span id="senha" class="erro">Campo obrigat처rio. *Minimo de 4 caracteres</span>
						</div>
						<div>
							<input type="password" placeholder="confirmar senha" name="confirmpassword" tabindex="6" />
							<span id="conf_senha" class="erro">Campo obrigat처rio</span>
							<span id="valida_senha" class="erro">A senha e a confirma챌찾o precisam ser iguais.</span>
						</div>
					</div>
					<input type="submit" class="cadBtn button2 fade3" value="confirmar" tabindex="14"/>
				</form>
			</div>
