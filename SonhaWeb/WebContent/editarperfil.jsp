      ...
      <div class="twelve columns centered">
      	...
      	<div class="cadBox">
				...
				<form onSubmit="return valida(this);">
                    ...
                    <div class="clear">
						<input type="text" placeholder="e-mail" name="email" tabindex="2" />
						<span id="email" class="erro">Campo obrigat처rio. Preencha o e-mail corretamente</span>
					</div>
                    <div class="clear">
						<div>
							<input type="text" placeholder="nome" name="name" tabindex="3" />
							<span id="nome" class="erro">Campo obrigat처rio. Preencha o nome corretamente.</span>
						</div>
					</div>
					<div class="clear">
						<div>
							<input type="text" placeholder="sobrenome" name="lastname" tabindex="4" />
							<span id="nome" class="erro">Campo obrigat처rio. Preencha o nome corretamente.</span>
						</div>
					</div>
					<div class="clear">
					...
					<input type="submit" class="cadBtn button2 fade3" value="confirmar" tabindex="7"/>
				</form>
			</div>
